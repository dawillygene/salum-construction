...
<head>
  ...
  <meta name="description" content="Salum Construction">
  <link href="assets/images/favicon/favicon.png" rel="icon">
  <title>Salum Construction</title>
  <link rel="stylesheet"
            ...
            <ul class="navbar-nav">
              <li class="nav__item with-dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav__item"><a href="index-2.html" class="nav__item-link">Home Moderm</a></li>
