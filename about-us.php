            ...
            <div class="slick-carousel"
              ...
              <div class="portfolio-item">
                ...
                <div class="portfolio__content">
                  ...
                  <p class="portfolio__desc">We understand that data is greatest asset when it comes to analyzing and
                    optimizing your supply chain performance.</p>
                  <a href="#" class="btn btn__loadMore"><span>Explore More</span><i
                      class="icon-arrow-right"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
              <div class="contact-panel mt--140">
                <div class="contact__panel-info">
                  <div class="contact__panel-info-top">
                    ...
                    <div class="contact-info-box">
                      ...
                      <ul class="contact__info-list list-unstyled">
                        <li>Email: <a href="https://7oroof.com/cdn-cgi/l/email-protection#4515372a282c2b2405722a372a2a236b262a28"><span class="__cf_email__" data-cfemail="c595b7aaa8acaba485f2aab7aaaaa3eba6aaa8">[email&#160;protected]</span></a></li>
                        <li>Support: <a href="https://7oroof.com/cdn-cgi/l/email-protection#b8e8cad7d5d1d6d9f88fd7cad7d7de96dbd7d5"><span class="__cf_email__" data-cfemail="87d7f5e8eaeee9e6c7b0e8f5e8e8e1a9e4e8ea">[email&#160;protected]</span></a></li>
                      </ul>
                    </div>
                  </div>
                ...
                <form method="post" action="https://7oroof.com/demos/promina/assets/php/contact.php" id="contactForm" class="contact__panel-form">
                  <div class="row">
                    <div class="col-sm-12">
